...
<head>
    ...
    <title>Volando.uy - Aerolínea</title>
...
<body>
    ...
    <nav id="gestion" class="gestion vuelos p-3 mt-4">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/altaRutaDeVuelo">Nueva Ruta</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/AltaVuelo">Nuevo Vuelo</a>
            </li>
            <li class="nav-item">
