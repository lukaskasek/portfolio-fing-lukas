...
@WebServlet("/homeAerolinea")
public class HomeAerolinea extends HttpServlet{
    private static final long serialVersionUID = 1L;
	public HomeAerolinea() {
		super();
	}
    ...
    IControladorRutasDeVuelo iCr = fab.getIControladorRutasDeVuelo();
        ...
        request.setAttribute("rutasConfirmadas", rutasConfirmadas);
	      request.getRequestDispatcher("/WEB-INF/home/MenuAerolinea.jsp").forward(request, response);
	    }
	}
