...
@WebServlet("/sideBarVisitante")
public class BarraLateralServletB extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/template/sideBars/sideBarVisitante.jsp");
