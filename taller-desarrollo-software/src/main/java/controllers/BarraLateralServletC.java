...
@WebServlet("/sideBarCliente")
public class BarraLateralServletC extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/template/sideBars/sideBarCliente.jsp");
