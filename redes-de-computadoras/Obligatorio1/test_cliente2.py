...
def test_cliente():
    ...
    print('=============================')
    client = Client()
    client.connect("100.100.0.2", 8081)
...
def prueba_concurrencia(num_clientes=5, host="100.100.0.2", port=8081):
...
if __name__ == "__main__":
    test_cliente()
    prueba_concurrencia(num_clientes=5, host="100.100.0.2", port=8081)